...
class OpenGeodeIOMesh(OpenGeodeProtocol):
    ...
    def createPoint(self, name, x, y, z):
        ...
        return self.registerObject("PointSet2D", name, point_set, vtk)
    ...
    def loadPointSet2D(self, filename):
        ...
        return self.registerObjectFromFile("PointSet2D",filename, point_set, vtk)
    ...
    def loadPointSet3D(self, filename):
        ...
        vtk = PointSetToPolydata(point_set, 3)
        return self.registerObjectFromFile("PointSet3D",filename, point_set, vtk)
    ...
    def loadEdgedCurve2D(self, filename):
        ...
        return self.registerObjectFromFile("EdgedCurve2D",filename, edged_curve, vtk)
    ...
    def loadEdgedCurve3D(self, filename):
        ...
        return self.registerObjectFromFile("EdgedCurve3D",filename, edged_curve, vtk)
    ...
    def loadPolygonalSurface2D(self, filename):
        ...
        return self.registerObjectFromFile("PolygonalSurface2D",filename, surface, vtk)
    ...
    def loadPolygonalSurface3D(self, filename):
        ...
        return self.registerObjectFromFile("PolygonalSurface3D",filename, surface, vtk)
    ...
    def loadTriangulatedSurface3D(self, filename):
        ...
        vtk = SurfaceToPolydata(surface, 3)
        return self.registerObjectFromFile("TriangulatedSurface3D",filename, surface, vtk)
    ...
    def loadPolyhedralSolid3D(self, filename):
        ...
        return self.registerObjectFromFile("PolyhedralSolid3D",filename, solid, vtk)
    ...
    def loadTetrahedralSolid3D(self, filename):
        ...
        vtk = SolidToPolydata(solid, 3)
        return self.registerObjectFromFile("TetrahedralSolid3D",filename, solid, vtk)
